...
- Isso comprova build, testes e smoke tests do workflow, mas nao comprova sync completo em
  producao.
- O endpoint publico observado `https://padaria-debortolo-api.onrender.com/api/health`
  retornou HTTP 503.
...
- API Render: `https://padaria-debortolo-api.onrender.com` quando estiver configurada.
